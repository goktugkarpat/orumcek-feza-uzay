...
self.addEventListener('activate', e => e.waitUntil((async () => {
  for (const k of await caches.keys()) if (k.startsWith('orumcek-feza-') && k !== CACHE) await caches.delete(k);   // only this game's old versions (other Feza games share the site)
